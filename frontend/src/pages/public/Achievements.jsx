            ...
            <Card key={achievement.id} style={{ padding: '2rem', display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                  ...
                  <span style={{ fontSize: '0.875rem', backgroundColor: 'var(--color-surface)', padding: '0.25rem 0.75rem', borderRadius: '9999px', color: 'var(--color-text-muted)' }}>{achievement.year}</span>
                </div>
