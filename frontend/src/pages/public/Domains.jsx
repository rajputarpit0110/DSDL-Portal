      ...
      <Container style={{ marginTop: '4rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          <div style={{ backgroundColor: 'var(--panel-solid)', padding: '2rem', borderRadius: '16px', border: '1px solid var(--color-border)', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.4)' }}>
            <h4 style={{ color: '#38bdf8', marginBottom: '0.75rem', fontSize: '1.2rem', fontWeight: 700 }}>Specialized Learning</h4>
          ...
          <div style={{ backgroundColor: 'var(--panel-solid)', padding: '2rem', borderRadius: '16px', border: '1px solid var(--color-border)', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.4)' }}>
            <h4 style={{ color: '#4ade80', marginBottom: '0.75rem', fontSize: '1.2rem', fontWeight: 700 }}>Collaborative Projects</h4>
